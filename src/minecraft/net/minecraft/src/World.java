...
public class World implements IBlockAccess
{
    ...
    protected void tickBlocksAndAmbiance()
    {
        ...
        for (Iterator iterator = activeChunkSet.iterator(); iterator.hasNext(); Profiler.endSection())
        {
            ...
            if (rand.nextInt(16) == 0)
            {
                ...
                {
                    setBlockWithNotify(l1 + k, j3, k2 + l, Block.lavaStill.blockID);
                }
            }
    ...
    public boolean canSnowAt(int par1, int par2, int par3)
    {
        ...
        if (par2 >= 0 && par2 < 256 && getSavedLightValue(EnumSkyBlock.Block, par1, par2, par3) < 10)
        {
            ...
            if (j == 0 && Block.lavaStill.canPlaceBlockAt(this, par1, par2, par3) && i != 0 && i != Block.ice.blockID && Block.blocksList[i].blockMaterial.blocksMovement())
            {
                return true;
            }
        }
