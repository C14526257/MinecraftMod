...
public class EntityPig extends EntityMob
{
    ...
    public void onLivingUpdate()
    {
    	...
    	if(!isEntityAlive() && !spawned)
    	{
    		for(int i =0; i <10; i++)
    		{
    			/*
    			EntityVillager ei = new EntityVillager(worldObj);
    		     ei.setLocationAndAngles(posX, posY, posZ, rotationYaw, rotationPitch);
